...
const Portfolio = require('./models/ApiModel')
...
mongoose.connect('mongodb://localhost:27017/apidata', {useNewUrlParser: true}, function(err) {
  if (err) throw err;
  console.log('success')
});
...
function onSuccess(response) {
  ...
  for( i=0; i<=arrayLength; i++) {
    ...
    assignDataValue(symbol, identifier, open, dayhigh, daylow, lastprice, previousclose, pchange, totaltradedvolume, totaltradedvalue, lastupdatetime, yearhigh, yearlow, percentagechange365d, percentagechange30d )

  }

}

function assignDataValue(symbol, identifier, open, dayhigh, daylow, lastprice, previousclose, pchange, totaltradedvolume, totaltradedvalue, lastupdatetime, yearhigh, yearlow, percentagechange365d, percentagechange30d) {
